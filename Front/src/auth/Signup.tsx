    ...
    <>
      <div className="flex items-center justify-center min-h-screen">
        <form onSubmit={loginSubmitHandler} className="md:p-8 w-full max-w-md rounded-lg md:border border-gray-200 mx-4">
          <div className="mb-4">
            {/* <h1 className="font-bold text-2xl">BuBBinGo_Eats</h1> */}
            {/* <h1 className="font-bold text-2xl">BuBBinGo_Cafe</h1> */}
            <img src="../../public/Fav Icon/icon .png" alt="logo" className="logo-login" />
          </div>
