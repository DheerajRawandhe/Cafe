...
<div 
// className="relative w-[95%] mx-auto h-40 md:h-72 lg:h-80"
className="relative w-[95%] mx-auto h-40 md:h-72 lg:h-80 bg-white flex items-center justify-center rounded-lg shadow-lg"
>
  <img
    src={singleRestaurant?.imageUrl || "Loading..."}
    alt="res_image"
